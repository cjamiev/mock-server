...
const { loadJSONFromFile, writeToFile, deleteFile } = require('./io');
...
const CONFIG_OVERRIDE_PATH = './storage/config.json';
const MOCK_FILE_PATH = './storage/responses';
const MOCK_REQUESTS_PATH = './storage/mockPaths.json';
